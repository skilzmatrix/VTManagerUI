...
@Component({
  selector: 'app-edit-products-invitations-franchise',
  templateUrl: './edit-products-invitations-franchise.component.html',
  styleUrls: ['./edit-products-invitations-franchise.component.css'],
...
export class EditProductsInvitationsFranchiseComponent implements OnInit {
  public id: string = '';
