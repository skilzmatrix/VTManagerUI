...
@Component({
  selector: 'app-products-invitations-franchise',
  templateUrl: './products-invitations-franchise.component.html',
  styleUrls: ['./products-invitations-franchise.component.css'],
