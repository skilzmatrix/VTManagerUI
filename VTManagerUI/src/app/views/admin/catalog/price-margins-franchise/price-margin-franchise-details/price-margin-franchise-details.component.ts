...
@Component({
  selector: 'app-price-margin-franchise-details',
  templateUrl: './price-margin-franchise-details.component.html',
  styleUrls: ['./price-margin-franchise-details.component.css'],
...
export class PriceMarginFranchiseDetailsComponent implements OnInit {
