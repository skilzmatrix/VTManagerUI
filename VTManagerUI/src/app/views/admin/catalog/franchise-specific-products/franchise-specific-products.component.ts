...
@Component({
  selector: 'app-franchise-specific-products',
  templateUrl: './franchise-specific-products.component.html',
  styleUrls: ['./franchise-specific-products.component.css'],
...
export class FranchiseSpecificProductsComponent implements OnInit {
